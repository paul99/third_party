...
{
    # Work around build error in libjingle/source/talk/base/helpers.cc if
    # USE_OPENSSL is defined. TODO(joth): remove when we have rolled to upstream
    # libjingle revision 39 or later.
    'use_openssl': 0,
  'includes': [
