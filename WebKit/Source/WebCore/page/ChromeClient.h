...
#if OS(ANDROID)
        enum ScrollingBehavior { AllowScrollingAncestors, DisallowScrollingAncestors };
        virtual void addOrUpdateScrollingLayer(GraphicsLayer*, ScrollableArea*, ScrollingBehavior) = 0;
        virtual void removeScrollingLayer(GraphicsLayer*) = 0;
        virtual void setLayerInputEventRegion(PlatformLayer* layer, const Region& region) = 0;
#endif
