...
// shorthand properties
    ...
    case CSSPropertyWebkitTextSizeAdjust: {
        ...
        if (primitiveValue->getIdent() == CSSValueAuto) {
          setTextSizeAdjust(TextSizeAdjustment(AutoTextSizeAdjustment));
        } else if (primitiveValue->getIdent() == CSSValueNone) {
          setTextSizeAdjust(TextSizeAdjustment(NoTextSizeAdjustment));
        } else {
          setTextSizeAdjust(TextSizeAdjustment(primitiveValue->getFloatValue()));
        }
#else
